...
public class BasicSchemaManipulation {
    ...
    public static FlowDef discardField(Tap<?, ?, ?> source, Tap<?, ?, ?> sink) {
        Pipe discardPipe = new Pipe("discard");
        discardPipe = new Discard(discardPipe, new Fields("discardme"));
        return FlowDef.flowDef()
                      .addSource(discardPipe, source)
                      .addTail(discardPipe)
                      .addSink(discardPipe, sink);
    }
    ...
    public static FlowDef retainField(Tap<?, ?, ?> source, Tap<?, ?, ?> sink) {
        Pipe retainPipe = new Pipe("retain");
        retainPipe = new Retain(retainPipe, new Fields("line"));
        return FlowDef.flowDef()
                      .addSource(retainPipe, source)
                      .addTail(retainPipe)
                      .addSink(retainPipe, sink);
    }
    ...
    public static FlowDef renameField(Tap<?, ?, ?> source, Tap<?, ?, ?> sink) {
        Pipe renamePipe = new Pipe("rename");
        renamePipe = new Rename(
          renamePipe,
          new Fields("renameme"),
          new Fields("line")
        );
        return FlowDef.flowDef()
                      .addSource(renamePipe, source)
                      .addTail(renamePipe)
                      .addSink(renamePipe, sink);
    }
